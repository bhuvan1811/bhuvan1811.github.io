...
// Submenu Toggles Start
$(document).ready(function () {
    if ($(window).width() > 767) {
        $('.menuToggle').on('mouseover', function () {
            // $(this).parents('.menuDropDown').find('.menuDropBox').slideDown();
            $(this).parent(".nav-item").addClass("activeMenu");
        });
        $('.menuToggle').on('mouseleave', function () {
            // $(this).parents('.menuDropDown').find('.menuDropBox').slideUp();
            $(this).parent(".nav-item").removeClass("activeMenu");
        });
        $(".menuDropBox").on("mouseover", function() {
    ...
    // else{
    //     $(".menuDropBox").on("click", function() {
    //         $('.menuDropBox').parent(".nav-item").removeClass("activeMenu");
    //         $(this).parent(".nav-item").addClass("activeMenu");
    //     });
    // }
});
