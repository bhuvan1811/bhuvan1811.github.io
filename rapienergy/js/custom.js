...
$(document).ready(function () {
    $(".addedProductSlider").slick({
        ...
        infinite: true,
        pauseOnHover: true,
        prevArrow:"<img class='a-left control-c prev slick-prev' src='./img/productSlidePrev.png'>",
      nextArrow:"<img class='a-right control-c next slick-next' src='./img/productSlideNext.png'>"
    });
});
...
$(document).on('click', '.accordionHeadItem', function(){
    if($(this).parents('.accordionBox').hasClass('active')){
        ...
        $('.accordionHeadItem').parents('.accordionBox').find('.accordionContent').slideUp();
